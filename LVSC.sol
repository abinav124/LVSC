 ...
 */
contract VscLockToken is Context, AccessControl, ERC20Burnable, ERC20Pausable {
    ...
    function updateLockStatus(address _account,bool _status) onlyMinter external {
        Lockstatus[_account]=_status;
    }

    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override(ERC20, ERC20Pausable) {
        require(!Lockstatus[from],"Account Locked");
        super._beforeTokenTransfer(from, to, amount);
    }
}